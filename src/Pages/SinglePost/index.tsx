...
function SinglePost(): JSX.Element {
  ...
  return (
    <div>
      <button className='flex justify-center items-center bg-gray-600 text-xs transition-all text-white rounded-sm py-2 px-4 hover:bg-gray-700'>Back</button>
      ...
      <div className='flex gap-10 py-8'>
        ...
        <img className='object-cover h-full w-full' src={'http://localhost:3002/' + post?.image} alt="postImage" />
        </div>
       }

<div className='flex justify-between items-center pt-2 pb-2'>
        <h3 className='text-sx text-white opacity-50'>{post?.username}</h3>
